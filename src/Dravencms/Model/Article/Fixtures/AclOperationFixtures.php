...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $operations = [
            'article' => [
                'edit' => 'Umožnuje editaci Article',
                'delete' => 'Umožnuje smazání Article'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\Article\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}